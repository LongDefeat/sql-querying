...
-- SELECT id, app_name FROM analytics WHERE id = 1880;
    --Web Browswer for Android

-- SELECT id, app_name FROM analytics WHERE last_updated = '2018-08-01';

--SELECT category, COUNT(*) FROM analytics GROUP BY category;

-- SELECT app_name, category FROM analytics ORDER BY reviews DESC LIMIT 5;

-- SELECT app_name, category, rating FROM analytics ORDER BY reviews <= 4.8 DESC LIMIT 1;
